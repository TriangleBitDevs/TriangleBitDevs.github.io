...
template = "page.html"
aliases = [
  "2026-05-13-socratic-seminar-52",
  "/2026-05-13-socratic-seminar-52/",
  "/2026/05/13/socratic-seminar-52"
]
...
- [Binary fuse filters as an alternative to BIP158's GCS](https://bitcoinops.org/en/newsletters/2026/05/01/#binary-fuse-filters-as-an-alternative-to-bip158-s-gcs)
...
- [Post-quantum HD wallets with fallback SPHINCS keys](https://bitcoinops.org/en/newsletters/2026/05/01/#post-quantum-hd-wallets-with-fallback-sphincs-keys)
- [Discussion of a post-quantum output type](https://bitcoinops.org/en/newsletters/2026/05/01/#discussion-of-a-post-quantum-output-type)
- [Post-quantum BIP86 recovery using zk-STARK proofs of BIP32 seeds](https://bitcoinops.org/en/newsletters/2026/05/01/#post-quantum-bip86-recovery-using-zk-stark-proofs-of-bip32-seeds)
- [Post Quantum Lightning: Layer by Layer](https://delvingbitcoin.org/t/post-quantum-lightning-layer-by-layer/2479)

# Lightning Network

- [Onion message jamming in the Lightning Network](https://bitcoinops.org/en/newsletters/2026/04/24/#onion-message-jamming-in-the-lightning-network)
- [Public fraud proof for just-in-time channels](https://bitcoinops.org/en/newsletters/2026/05/08/#public-fraud-proof-for-just-in-time-channels)
- [Core Lightning 26.04](https://github.com/ElementsProject/lightning/releases/tag/v26.04)
- [Eclair adds support for the official splicing protocol](https://github.com/ACINQ/eclair/pull/2887)
